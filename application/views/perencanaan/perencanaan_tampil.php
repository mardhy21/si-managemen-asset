                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a target="_blank" class="btn btn-sm btn-primary" href="<?php echo base_url().'perencanaan/print_data/'.$perencanaan->id_perencanaan;?>">Cetak Invoice</a>
                          <?php if ($perencanaan->status_data == 'Disetujui'): ?>
                            
                          <a href="<?php echo base_url('perencanaan/pembatalan_perencanaan/'.$perencanaan->id_perencanaan) ?>" onclick="return confirm('Apakah Anda Akan Membatalkan Transaksi Ini ?')" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Cancel</a>
                          <?php endif ?>
                        </td>
