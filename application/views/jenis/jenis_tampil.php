            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">
                    <a href="<?php echo base_url('jenis/tambah'); ?>" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i> Tambah</a>
                  </h3>
                  <div class="box-tools">
              ...
              <table class="table table-hover datatable"  width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th width="150">Nama Jenis Asset</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button onclick="deleteConfirm('<?php echo base_url('jenis/delete/'.$jenis->id_jenis_asset) ?>')"
